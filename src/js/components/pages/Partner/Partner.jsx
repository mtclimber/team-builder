            ...
            <div className="formContainer">
              <h2>Partner Info</h2>
                <div className="form-group">
              	...
              	<div className="form-group">
              		<label for="zip_id" className="control-label">Zip Code</label>
